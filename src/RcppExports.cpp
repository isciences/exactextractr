...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(CPP_exact_extract(rast, weights, wkb, default_value, default_weight, include_xy, include_cell_number, p_area_method, include_cols, src_names, p_weights_names, warn_on_disaggregate));
    return rcpp_result_gen;
END_RCPP
}
// CPP_stats
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_exactextractr_CPP_exact_extract", (DL_FUNC) &_exactextractr_CPP_exact_extract, 12},
