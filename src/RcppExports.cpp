...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(CPP_exact_extract(rast, weights, wkb, default_value, default_weight, include_xy, include_cell_number, include_area, area_weights, p_area_method, include_cols, src_names, p_weights_names, warn_on_disaggregate));
    return rcpp_result_gen;
END_RCPP
}
// CPP_stats
Rcpp::NumericMatrix CPP_stats(Rcpp::S4& rast, Rcpp::Nullable<Rcpp::S4> weights, const Rcpp::RawVector& wkb, double default_value, double default_weight, Rcpp::Nullable<Rcpp::CharacterVector>& p_area_method, const Rcpp::StringVector& stats, int max_cells_in_memory, const Rcpp::Nullable<Rcpp::NumericVector>& quantiles);
RcppExport SEXP _exactextractr_CPP_stats(SEXP rastSEXP, SEXP weightsSEXP, SEXP wkbSEXP, SEXP default_valueSEXP, SEXP default_weightSEXP, SEXP p_area_methodSEXP, SEXP statsSEXP, SEXP max_cells_in_memorySEXP, SEXP quantilesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::S4& >::type rast(rastSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(CPP_stats(rast, weights, wkb, default_value, default_weight, p_area_method, stats, max_cells_in_memory, quantiles));
    return rcpp_result_gen;
END_RCPP
}
// CPP_resample
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_exactextractr_CPP_exact_extract", (DL_FUNC) &_exactextractr_CPP_exact_extract, 14},
    {"_exactextractr_CPP_stats", (DL_FUNC) &_exactextractr_CPP_stats, 9},
