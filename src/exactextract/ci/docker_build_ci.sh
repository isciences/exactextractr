...
docker build --pull --build-arg GEOS_VERSION=3.5.1 -t isciences/exactextract-test-env:geos35 - < Dockerfile.unittes
docker push isciences/exactextract-test-env:geos35

docker build --pull --build-arg GEOS_VERSION=3.6.3 -t isciences/exactextract-test-env:geos36 - < Dockerfile.unittest
docker push isciences/exactextract-test-env:geos36

docker build --pull --build-arg GEOS_VERSION=3.7.2 -t isciences/exactextract-test-env:geos37 - < Dockerfile.unittest
