...
| variance       | (&Sigma;c<sub>i</sub>(x<sub>i</sub> - x&#773;)/(&Sigma;c<sub>i</sub>)                | Population variance of cell values that intersect the polygon, taking into account coverage fraction. | - | 1.10 |
